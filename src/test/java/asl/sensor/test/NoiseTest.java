...
public class NoiseTest {
  ...
  public void testResultsData1PSD1() {
    int idx = 0;
    double psdCheck = -140.625852232;
    double noiseCheck = -141.11424077;
    ...
    try{
      ...
      assertEquals(noiseCheck, noiseResults, 1E-15);
      assertEquals(psdCheck, psdResults, 1E-15);
  ...
  public void testResultsData1PSD2() {
    int idx = 1;
    double psdCheck = -142.212657637;
    double noiseCheck = -142.553305407;
    // everything below here same for every test
    try{
      XYSeriesCollection xysc = setUpTest1();
      // first 3 data, PSDs of each input
  ...
  public void testResultsData1PSD3() {
    int idx = 2;
    double psdCheck = -139.217963773;
    double noiseCheck = -138.729291105;
    // everything below here same for every test
    try{
      XYSeriesCollection xysc = setUpTest1();
      // first 3 data, PSDs of each input
